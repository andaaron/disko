...
// Deprecated: use sysfs.IsSysPathRAID directly; kept for backward compatibility.
...
// GetSysPaths returns resolved PCI device paths for a RAID driver.
// Deprecated: use sysfs.GetSysPaths directly; kept for backward compatibility.
